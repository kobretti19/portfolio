...
const ContactCard: FC<ContactCardProps> = ({ icon, btnText, text, title }) => {
  return (
    <div className='bg-secondary-background border-border rounded-lg relative overflow-hidden py-5 pl-[25px] shadow-md '>
      <div className='z-20 flex flex-col gap-8 justify-between items-start'>
        ...
        {/* Body text*/}
        <div>
          <h2 className='font-bold text-xl lg:text-2xl'>{text}</h2>
        </div>
